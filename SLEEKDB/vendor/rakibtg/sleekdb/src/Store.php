  ...
  private function setConfiguration(array $configuration)
  {
    ...
    if($this->timeout !== false){
      $message = 'The "timeout" configuration is deprecated and will be removed with the next major update.' .
        ...
        trigger_error('The "timeout" configuration is deprecated and will be removed with the next major update. Please remove the "timeout" configuration from your code and use the set_timeout_limit() function if needed.', E_USER_DEPRECATED);
